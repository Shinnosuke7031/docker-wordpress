...
function generate_system_information_text( $environment, $theme, $active_plugins, $inactive_plugins, $welcart_information){
...
function usces_download_system_information(){
    ...
    $data = generate_system_information_text( $environment, $theme, $active_plugins, $inactive_plugins, $welcart_information);
    $result = array(
        'status' => true,
        'data' => $data,
        'filename' => $filename
